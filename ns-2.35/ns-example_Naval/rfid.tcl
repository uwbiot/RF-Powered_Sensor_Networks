...
$reader1 set id_ 200 #Reader ID
$reader1 set singularization_ 0 #Deprecated
$reader1 set service_ 2 

$reader1 set t2_ 0.09 #Time to wait before check collisions
$reader1 set c_ 1 #Q Algorithm constant c: Common values: 0.2, 0.3 , 1.
$reader1 set qValue_ 4 #Initial Q Value
$reader1 set Qfp_ 4.0 #Initial Q Value (float point)
...
$reader1 set estMethod_ 2 #Frame size estimation method (backlog): 0 (lower bound), 1  (Schoute) 2 (Eom-Lee) 3 (Mota)
